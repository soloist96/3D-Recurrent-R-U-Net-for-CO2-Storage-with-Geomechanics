...
def create_vae(input_shape, depth):
    ...
    enc3 = conv_bn_relu(64, 3, 3, 3, stride=(2, 2, 2))(enc2)
    ...
    x = time_res_conv(128, 3, 3, 3)(x)
    dec4 = time_res_conv(128, 3, 3, 3)(x)

    merge4 = concatenate([time_enc4, dec4], axis = -1)
    dec3 = time_dconv_bn_nolinear(128, 3, 3, 3, stride=(1, 1, 1))(merge4)
    merge3 = concatenate([time_enc3, dec3], axis = -1)
    dec2 = time_dconv_bn_nolinear(64, 3, 3, 3, stride=(2, 2, 2))(merge3)
