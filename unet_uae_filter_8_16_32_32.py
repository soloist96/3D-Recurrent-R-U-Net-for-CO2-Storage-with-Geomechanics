...
def create_vae(input_shape, depth):
    ...
    enc1 = conv_bn_relu(8, 3, 3, 3, stride=(2, 2, 2))(input)
    time_enc1 = RepeatConv(depth)(enc1)
    enc2 = conv_bn_relu(16, 3, 3, 3, stride=(1, 1, 1))(enc1)
    ...
    enc4 = conv_bn_relu(32, 3, 3, 3, stride=(1, 1, 1))(enc3)
    time_enc4 = RepeatConv(depth)(enc4)

    # x = res_conv(128, 3, 3, 3)(enc4)
    # x = res_conv(128, 3, 3, 3)(x)
    #x = res_conv(128, 3, 3, 3)(x)
    x = res_conv(32, 3, 3, 3)(enc4)
    x = res_conv(32, 3, 3, 3)(x)
    ...
    x = time_res_conv(32, 3, 3, 3)(x)
    dec4 = time_res_conv(32, 3, 3, 3)(x)

    merge4 = concatenate([time_enc4, dec4], axis = -1)
    dec3 = time_dconv_bn_nolinear(32, 3, 3, 3, stride=(1, 1, 1))(merge4)
    ...
    dec1 = time_dconv_bn_nolinear(16, 3, 3, 3, stride=(1, 1, 1))(merge2)
    
    merge1 = concatenate([time_enc1, dec1], axis = -1)
    dec0 = time_dconv_bn_nolinear(8, 3, 3, 3, stride=(2, 2, 2))(merge1)
